				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<h4 style="text-align: center">
							...
							<a class="btn btn-primary" href="write_reviews.jsp" style="width:130px">Write Review</a>
						<a class="btn btn-primary" href="read_reviews.jsp"  style="width:130px">View Reviews</a>
						</h4>
					</div>
				</div>
			</li>
