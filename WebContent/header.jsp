...
<html lang="en">
   ...
   <body onload="init()">
      ...
      <%
         ...
         String fromCouponValidation = request.getParameter("fromCouponValidation") != null
         		? request.getParameter("fromCouponValidation") : " ";
         ...
         <div class="container">
            <div id="welcomeLine" class="row" style="display: flex;">
               ...
               <div class="span6">
                  ...
                  <div class="pull-right">
                     <a href="product_summary.jsp?myCart=true"><span
            ...
            <div id="logoArea" class="navbar">
               ...
               <div class="navbar-inner">
                  <a class="brand" href="index.jsp"><img
                     src="themes/images/logo.png" alt="Clicknpick"
                  ...
                  <li style="display: -webkit-box;">
                     <ul id="topMenu" class="nav pull-right">
                        <li style="display: -webkit-box;">
                           ...
                           User</span></a> <a href="salesman_operations.jsp"><span
