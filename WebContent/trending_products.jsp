					...
					<div class="row-fluid">
						<div id="featured" class="">
								<div class="carousel-inner">
									...
									%>
										<ul class="thumbnails">
											<h4>Top five Trending Products</h4>
											...
											<li class="span3" style="width: 17.076923% !important;">
												<div class="thumbnail">
													<a
														href="product_details.jsp?productId=<%=product.getId()%>">
														<img
													...
													<div class="caption">
														...
														<h4>
															<a class="btn"
																href="product_details.jsp?productId=<%=product.getId()%>">VIEW</a>
										...
										%>
											...
											<li class="span3" style="width: 17.076923% !important;">
												<div class="thumbnail">
													...
													<h5>
														Rating
														<%=trendingProduct.getReviewRating()%></h5>
												</div>
											</li>
											<%
												}
										...
										<h4>Top five zip-codes where maximum number of products
											sold</h4>
										<%
