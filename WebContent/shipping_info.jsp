...
<% session.setAttribute("checkoutAmount", request.getParameter("checkoutAmount")); %>
	...
	<form action="payment_gateway.jsp" class="form-horizontal" >
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="fname" id="inputFname" placeholder="First Name" required="required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="postcode" id="postcode" placeholder="Zip / Postal Code"/> 
			</div>
		</div>
	...
	<div class="control-group">
			<div class="controls">
				<input class="btn btn-large btn-success" type="submit" value="Continue to Payment Information" />
			</div>
		</div>		
	</form>
</div>
